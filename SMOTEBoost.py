...
class SMOTEBoost(AdaBoostClassifier):
    ...
    def fit(self, X, y, sample_weight=None, minority_target=None):
        ...
        if sample_weight is None:
            # Initialize weights to 1 / mmples.
        ...
        for iboost in range(self.n_estimators):
            ...
            # SMOTE step.
            if len(X_min) >= self.k_neighbors:
                if is_cat:
                    sm = SMOTENC(categorical_features = CAT,  k_neighbors = self.k_neighbors)
                else:
                    sm = SMOTE(k_neighbors = self.k_neighbors)
            ...
            if iboost < self.n_estimators - 1:
                ...
                if length != 0:
                    sample_weight = sample_weight[:-length]
